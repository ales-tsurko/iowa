...
fn test_recursive_fibonacci() {
    ...
    let method = runtime
        .create_method(vec!["n".to_string()], source)
        .unwrap();
...
fn test_object_manipulation() {
    ...
    let lobby = runtime.lobby();
    let method = runtime
        .create_method(vec!["name".to_string(), "age".to_string()], source)
        .unwrap();
...
fn test_method_composition() {
    ...
    let method = runtime
        .create_method(vec!["a".to_string(), "b".to_string()], calc_source)
        .unwrap();
...
fn test_loops_with_counter() {
    ...
    let lobby = runtime.lobby();
    let method = runtime
        .create_method(vec!["max".to_string()], source)
        .unwrap();
